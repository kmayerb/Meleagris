...
description = "meleagris: is a turkey of package for small scientific Python projects"
# Long description will go up on the pypi page
long_description = """
Meleagris
========
Meleagris used Shablona  a template project for small scientific Python projects.
...
URL = "http://github.com/kmayerb/Meleagris"
DOWNLOAD_URL = ""
LICENSE = "MIT"
AUTHOR = "Koshlan Mayer-Blackwell"
AUTHOR_EMAIL = "kmayerbl@fredhutch.org"
PLATFORMS = "OSX Independent"
MAJOR = _version_major
MINOR = _version_minor
MICRO = _version_micro
VERSION = __version__
PACKAGE_DATA = {'meleagris': ['data/data_file.txt']}
REQUIRES = ["numpy"]